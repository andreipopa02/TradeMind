    ...
    return (
        <>
            ...
            {showActions && (
                ...
                >
                    <button className="edit-btn" onClick={() => { setShowActions(false); onEdit(trade); }}>✏️ Edit</button>
                    <button className="delete-btn" onClick={() => { setShowActions(false); onDelete(trade); }}>🗑️ Delete</button>
                </div>
            )}
        </>
    );
